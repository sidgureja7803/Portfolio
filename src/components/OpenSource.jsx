...
const ContributionCard = ({ title, description, type, link }) => {
  return (
    <div
      className="bg-tertiary p-6 rounded-xl sm:w-[400px] w-full hover:shadow-lg transition-shadow duration-300 border border-gray-700 cursor-pointer"
    ...
    >
      <div className="flex flex-col h-full">
        ...
        <div className="relative h-48 mb-4 bg-gradient-to-br from-purple-900/20 to-blue-900/20 rounded-xl border-2 border-dashed border-gray-600 flex items-center justify-center group">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent rounded-xl opacity-0 group-hover:opacity-100">
...
const OpenSourceCard = ({ title, description, link, stars, forks, tech }) => {
  return (
    <div className="bg-tertiary p-5 rounded-xl sm:w-[360px] w-full shadow-md hover:shadow-lg">
      <div className="relative w-full h-[230px] cursor-pointer group" onClick={() => window.open(link, "_blank")}>
        <div className="absolute inset-0 flex flex-col justify-between p-4 bg-black bg-opacity-70 opacity-0 group-hover:opacity-100">
          <div>
...
const OpenSource = () => {
  ...
  return (
    <div className="py-10">
      ...
      <div className="mt-20">
        <h3 className="text-white font-bold text-[30px] mb-10 text-center">
          Major Programs
        </h3>
      ...
      <div className="mt-16 flex justify-center">
        <a
          ...
          className="flex items-center gap-3 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white px-8 py-3 rounded-lg font-semibold shadow-md"
        >
          <FaGithub className="text-xl" />
